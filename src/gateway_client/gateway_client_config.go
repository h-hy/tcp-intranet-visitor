...
type GatewayClientConfig struct {
	...
	UUID                   string
	GatewayServerList      []string
}

func NewGatewayClientConfig(configfile string) *GatewayClientConfig {
	return &GatewayClientConfig{
		configfile: configfile,
	}
}

func (self *GatewayClientConfig) LoadConfig() error {
...
func (self *GatewayClientConfig) DumpConfig() {
	//fmt.Printf("Mode: %s\nListen: %s\nServer: %s\nLogfile: %s\n",
